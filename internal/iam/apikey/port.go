...
type APIKeyRepository interface {
	...
	FindByID(ctx context.Context, id kernel.APIKeyID, tenantID kernel.TenantID) (*APIKey, error)
	...
	Delete(ctx context.Context, id kernel.APIKeyID, tenantID kernel.TenantID) error
